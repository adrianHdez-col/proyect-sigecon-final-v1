-- ============================================================
-- SIGECON - Base de Datos Limpia para Despliegue (Railway)
-- Versión: 2.0
-- Fecha: 2026-06-30
-- Hash de contraseña para '12345678': $2b$10$h/orCxUOXsCoJ/5ypv2i/e4.PSMkRba3oxBNOa/yRNb9rGNt04Jgq
-- ============================================================

CREATE DATABASE IF NOT EXISTS sigecon CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE sigecon;
...
-- Usuarios (contraseña: 12345678 - hash bcrypt verificado)
...
( (SELECT id FROM roles WHERE nombre='SU'), NULL, 'superadmin@empresa.com', '$2b$10$h/orCxUOXsCoJ/5ypv2i/e4.PSMkRba3oxBNOa/yRNb9rGNt04Jgq', 'Super Administrador', '555-0001', TRUE),
-- RRHH de TechCorp
( (SELECT id FROM roles WHERE nombre='RRHH'), (SELECT id FROM empresas WHERE subdominio='techcorp'), 'rrhh@techcorp.com', '$2b$10$h/orCxUOXsCoJ/5ypv2i/e4.PSMkRba3oxBNOa/yRNb9rGNt04Jgq', 'Laura Gómez', '555-1234', TRUE),
-- Evaluador de TechCorp
( (SELECT id FROM roles WHERE nombre='Evaluador'), (SELECT id FROM empresas WHERE subdominio='techcorp'), 'psicologo@techcorp.com', '$2b$10$h/orCxUOXsCoJ/5ypv2i/e4.PSMkRba3oxBNOa/yRNb9rGNt04Jgq', 'Carlos Méndez', '555-5678', TRUE),
-- RRHH de Soluciones RH
( (SELECT id FROM roles WHERE nombre='RRHH'), (SELECT id FROM empresas WHERE subdominio='solucionesrh'), 'rrhh@solucionesrh.com', '$2b$10$h/orCxUOXsCoJ/5ypv2i/e4.PSMkRba3oxBNOa/yRNb9rGNt04Jgq', 'Ana Martínez', '555-9876', TRUE),
-- Candidatos externos (sin empresa)
( (SELECT id FROM roles WHERE nombre='Candidato'), NULL, 'juan.perez@example.com', '$2b$10$h/orCxUOXsCoJ/5ypv2i/e4.PSMkRba3oxBNOa/yRNb9rGNt04Jgq', 'Juan Pérez', '555-8765', TRUE),
( (SELECT id FROM roles WHERE nombre='Candidato'), NULL, 'maria.lopez@example.com', '$2b$10$h/orCxUOXsCoJ/5ypv2i/e4.PSMkRba3oxBNOa/yRNb9rGNt04Jgq', 'María López', '555-4321', TRUE);
