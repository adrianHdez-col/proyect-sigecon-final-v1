...
export const listSavedVacancies = async (req: Request, res: Response) => {
  try {
...
export const saveVacancyForMe = async (req: Request, res: Response) => {
  try {
    const user = req.user as any;
...
export const unsaveVacancyForMe = async (req: Request, res: Response) => {
  try {
    const user = req.user as any;
